<?php
	...
	/*
	Template Name: lato rezerwuj-dunajec
	*/
?>
<body id="rezerwuj-dunajec" class='<?php do_action( 'body_hook' ); ?>'>
 <header>
		            ...
		            <div class="select select-single">
		                <div class="select-head flex flex-items-center flex-justify-center flex-justify-start-mm">
		                 ...
		                 <div class="select-options">
		                    <div class="option flex-justify-center flex-justify-start-mm">Sromowce niżne - Szczawnica</div>
		                    <div class="option flex-justify-center flex-justify-start-mm">Sromowce niżne - Krościenko</div>   <div class="option flex-justify-center flex-justify-start-mm">Niedzica - Szczawnica</div>
		      	   ...
		      	   <div class="select anti-select">
		                <div class="select-head flex flex-items-center flex-justify-center flex-justify-start-mm">
		                    <div class="title">wybrana trasa: Sromowce niżne - Szczawnica</div>
		                </div>
		            </div>
