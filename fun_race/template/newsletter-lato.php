    ...
    <div class="container">
        ...
        <form>
            <div class="box flex flex-column flex-row-ms">
                ...
                <button class="flex flex-items-center flex-justify-center"><div class="send">Wyślij</div> <div class="arrow"><img src="<?php echo get_template_directory_uri(); ?>/img/arrow_blue.png"></div></button>
            </div>
        </form>
