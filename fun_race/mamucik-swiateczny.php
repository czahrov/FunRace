        ...
        <div class="container padding">
            <div class="intro flex flex-column flex-row-ds">
                ...
                <div class="col col1 no-shrink-ds flex flex-column flex-row-ml flex-column-ds">
                    <div class="image flex flex-items-center flex-justify-center flex-justify-start-ds"><img src="<?php echo get_template_directory_uri(); ?>/img/mamucik-swiateczny.jpg" alt="mamucik-kurs-świąteczny"></div>
                    <div class="boxes">
                        <div class="box">
                ...
                <div class="col col2">
                      <div class="images flex flex-column flex-row-mm flex-justify-around flex-items-center">
                          ...
                          <div class="text">Mamucik kurs świąteczny - szczegóły oferty</div>
                      </div>
                      ...
                      <div class="pils">
                        <div class="tab-wrapper">
                          ...
                          <ul class="tab-menu flex flex-column flex-row-mm">
                            <li class="active">Mamucik kurświąteczny</li>
                            <li>Program kursu</li>
                            <li>Dlaczego kurs świąteczny</li>
                            <li>Cennik</li>
                          ...
                          <div class="tab-content">
                            <div>
                                <p>Kurs świąteczny to 4 dniowy kurs narciarski dla dzieci i młodzieży organizowany w okresie świąteczno – noworocznym. Jest to idealna propozycja na pierwsze tej zimy narciarskie szusy – zarówno dla odświeżenia umiejętności jak i stawiania pierwszych kroków. W świecie zabawy i kolorowych pomocy dydaktycznych, przy wsparciu i motywacji MAMUCIKA i wykwalifikowanej kadry instruktorskiej nasi uczniowie odkryją wspaniały świat narciarstwa – ucząc się i doskonaląc umiejętności techniczne. W trakcie trwania kursu przeznaczymy czas na przerwę i regenerację sił. Na zakończenie szkolenia, na naszych narciarzy czeka moc mamucikowych nagród i niespodzianek!</p>
                                <div class="title">
                                    BEZPIECZEŃSTWO I PROFESJONALIZM SZKOLEŃ NARCIARSKICH FUNRACE
                                </div>
                                <p>Szkoła Narciarska FUNRACE jako jedyna szkoła na Jaworzynie posiada licencję SITN PZN, potwierdzającą najwyższe kwalifikacje do prowadzenia szkoleń narciarskich. Szkolenia i kursy narciarskie dla dzieci realizowane są wg. pierwszego w Polsce Programu Nauczania Dzieci SITN PZN, którego jesteśmy współautorami. Nasi Instruktorzy to certyfikowani eksperci nauczania dzieci (poznaj naszych instruktorów).</p>
                            </div>
                            <div>
                                <div class="timelist">
                                    <h3>Dzień I (środa 28.12.2016)</h3>
                                    <ul>
                                        <li class="flex">
                                 ...
                                 <div class="timelist">
                                    <h3>Dzień II - V (29-31.12.2016)</h3>
                                    <ul>
                                        <li class="flex">
                                               <div class="ico no-shrink"></div>
                                            <div class="row">
                            ...
                            <div>
                                <div class="average-list">
                                    <h3>Dlaczego wybrać <span>MAMUCIK KURS ŚWIĄTECZNY?</span></h3>
                                    <ul>
                                        <li><span>   13 godz. zajęć na śniegu</span></li>
                                        <li><span>2 godz. opieki i zajęć poza narciarskich</span></li>
                                        <li><span>idealna form szkolenia na pierwsze tej zimy narciarskie szusy – zarówno dla odświeżenia umiejętności jak i stawiania pierwszych kroków.</span></li>
                            ...
                            <div>
                                 <div class="average-list">
                                   <div class="cost">
                                       <div class="price">Cena: 550 zł</div>
