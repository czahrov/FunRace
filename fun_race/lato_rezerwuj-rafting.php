<?php
	...
	*/
?>
<body class="lato" id="rezerwuj-rafting">
 <header>
		            ...
		            <div class="select select-single">
		                <div class="select-head flex flex-items-center flex-justify-center flex-justify-start-mm">
		                 ...
		                 <div class="select-options">
		                    <div class="option flex-justify-center flex-justify-start-mm">RAFTING na Dunajcu</div>
		                    <div class="option flex-justify-center flex-justify-start-mm">RAFTING na rzece Poprad</div>   <div class="option flex-justify-center flex-justify-start-mm">RAFTING rzeka Váh – SŁOWACJA</div>
		                       <div class="option flex-justify-center flex-justify-start-mm">RAFTING rzeka Belá – SŁOWACJA</div>

		                </div>
		            </div>
		      	   <div class="select anti-select">
		                <div class="select-head flex flex-items-center flex-justify-center flex-justify-start-mm">
		                    <div class="title">wybrana trasa: RAFTING na Dunajcu</div>
		                </div>
		            </div>
