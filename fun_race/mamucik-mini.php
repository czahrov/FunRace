<?php
	...
	/*
	Template Name: mamucik-mini
	*/
?>
<body id="mamucik-mini" class='<?php do_action( 'body_hook' ); ?>'>
 <header>
        ...
        <div class="container padding">
            <div class="intro flex flex-column flex-row-ds">
                ...
                <div class="col col1 no-shrink-ds flex flex-column flex-row-ml flex-column-ds">
                    <div class="image flex flex-items-center flex-justify-center flex-justify-start-ds"><img src="<?php echo get_template_directory_uri(); ?>/img/mamucik-mini.jpg" alt="mamucik-kurs-mini"></div>
                    <div class="boxes">
                        <div class="box">
                            ...
                            <div class="content">
                                <ul>
                                    <li>dzieci w wieku 4-5 lat</li>
                                    <li><a href="mamucik-feryjny.html">* dla dzieci starszych polecamy MAMUCIK KURS FERYJNY(czytaj więcej)</a></li>
                                </ul>
                            </div>
                        </div>
                          <div class="box">
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                <p>Poniedziałek - Piątek 9:30 - 12:00</p>
                            </div>
                        </div>
                        <div class="box">
                            <div class="bar flex flex-items-center">
                ...
                <div class="col col2">
                      <div class="images flex flex-column flex-row-mm flex-justify-around flex-items-center">
                          ...
                          <div class="text">Mamucik kurs mini - szczegóły oferty</div>
                      </div>
                      ...
                      <div class="pils">
                        <div class="tab-wrapper">
                          ...
                          <ul class="tab-menu flex flex-column flex-row-mm">
                            <li class="active">Mamucik kurs mini</li>
                            <li>Program kursu</li>
                            <li>Dlaczego kurs mini</li>
                            <li>Cennik</li>
                          ...
                          <div class="tab-content">
                            <div>
                                <p>Kurs mini to 5 dniowy kurs narciarski dla dzieci stworzony z myślą o najmłodszych narciarzach, przeznaczony zarówno dla dzieci, które rozpoczynają przygodę z narciarstwem jak również dla tych, które pierwsze kroki maja już za sobą. Program kursu MAMUCIK MINI został starannie dobrany do możliwości uczenia się dzieci w wieku 4-5 lat.  Mniejszy wymiar godzinowy kursu, kolorowy świat pomocy dydaktycznych, przewaga formy zabawowej, stwarzają optymalne warunki do nauki i odkrywania wspaniałego świata narciarstwa. Na zakończenie szkolenia, na naszych narciarzy czeka moc mamucikowych nagród i niespodzianek!</p>
                                <div class="title">
                                    ...
                                    <ul>
                                        ...
                                        <li class="flex">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="desc">Szkolenie narciarskie w grupach. <br>Odbiór dzieci.</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                 ...
                                 <div class="timelist">
                                    ...
                                    <ul>
                                        ...
                                        <li class="flex">
                                               <div class="ico no-shrink"></div>
                                            <div class="row">
                                                <div class="value">9:45 - 12:00</div>
                                                <div class="desc">Szkolenie narciarskie w grupach<br>Odbiór dzieci.</div>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div>
                                <div class="average-list">
                                    <h3>Dlaczego wybrać <span>MAMUCIK KURS MINI?</span></h3>
                                    <ul>
                                        <li><span>   11 godz. zajęć na śniegu</span></li>
                                         <li><span>25% zniżki na wypożyczenie sprzętu narciarskiego w Wypożyczalni FUNRACE – Centrum Testowym HEAD</span></li>
                                        <li><span>optymalne warunki nauki i narciarskiej zabawy dla najmłodszych narciarzy</span></li>
                            ...
                            <div>
                                 <div class="average-list">
                                   <div class="cost">
                                       <div class="price">Cena: 499 zł</div>
                                    ...
                                    <ul>
                                        ...
                                        <li>            szkolenia w grupach 3 – 5 os podzielonych wg. wieku i umiejętności.                                     <br>  1 instruktor na grupę</li>
