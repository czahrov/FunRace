<?php
	...
	/*
	Template Name: mamucik-feryjny
	*/
?>
<body id="mamucik-feryjny" class='<?php do_action( 'body_hook' ); ?>'>
 <header>
        ...
        <div class="container padding">
            <div class="intro flex flex-column flex-row-ds">
                ...
                <div class="col col1 no-shrink-ds flex flex-column flex-row-ml flex-column-ds">
                    <div class="image flex flex-items-center flex-justify-center flex-justify-start-ds"><img src="<?php echo get_template_directory_uri(); ?>/img/mamucik-feryjny.jpg" alt="mamucik-kurs-świąteczny"></div>
                    <div class="boxes">
                        <div class="box">
                            ...
                            <div class="content">
                                <ul>
                                    <li>dzieci w wieku 5-12 lat</li>
                                    <li>młodzież w wieku 12-15 lat</li>
                                    <li><a href="mamucik-mini.html">* dla dzieci 4-5 lat polecamy kurs MAMUCIK MINI(czytaj więcej)</a></li>
                                </ul>
                            </div>
                        </div>
                          <div class="box">
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                <p>Poniedziałek - Piątek 9:30 - 13:30</p>
                            </div>
                        </div>
                        <div class="box">
                            <div class="bar flex flex-items-center">
                                <div class="icon"><img src="<?php echo get_template_directory_uri(); ?>/img/icons/kalendarz.png" alt="kalendarz"></div>
                ...
                <div class="col col2">
                      <div class="images flex flex-column flex-row-mm flex-justify-around flex-items-center">
                          <div class="new">
                              <img src="<?php echo get_template_directory_uri(); ?>/img/best-seller.png" alt="nowość">
                          </div>
                          <div class="text">Mamucik kurs feryjny - szczegóły oferty</div>
                      </div>
                      ...
                      <div class="pils">
                        <div class="tab-wrapper">
                          ...
                          <ul class="tab-menu flex flex-column flex-row-mm">
                            <li class="active">Mamucik kurs feryjny</li>
                            <li>Program kursu</li>
                            <li>Dlaczego kurs feryjny</li>
                            <li>Cennik</li>
                          ...
                          <div class="tab-content">
                            <div>
                                <p>Kurs feryjny to 5 dniowy kurs narciarski dla dzieci i młodzieży na każdym poziomie zaawansowania. W pierwszym dniu kursu, dzieci przydzielane są do grup. Zarówno zakres nauczanych umiejętności jak i grupy szkoleniowe dobierane są wg. wieku i umiejętności. Program kurs narciarskiego AKADEMII MAMUCIK został starannie dobrany do możliwości uczenia się dzieci. W świecie zabawy i kolorowych pomocy dydaktycznych, przy wsparciu i motywacji MAMUCIKA i wykwalifikowanej kadry instruktorskiej nasi uczniowie odkryją wspaniały świat narciarstwa – ucząc się i doskonaląc umiejętności techniczne. W trakcie trwania kursu przeznaczamy czas na przerwę i regenerację sił. Na zakończenie szkolenia, na naszych narciarzy czeka moc mamucikowych nagród i niespodzianek!</p>
                                <div class="title">
                                    BEZPIECZEŃSTWO I PROFESJONALIZM SZKOLEŃ NARCIARSKICH FUNRACE
                                </div>
                                <p>Szkoła Narciarska FUNRACE jako jedyna szkoła na Jaworzynie posiada licencję SITN PZN, potwierdzającą najwyższe kwalifikacje do prowadzenia szkoleń narciarskich. Szkolenia i kursy dla dzieci realizowane są wg. pierwszego w Polsce Programu Nauczania Dzieci SITN PZN, którego jesteśmy współautorami. Nasi Instruktorzy to certyfikowani eksperci nauczania dzieci <a href="">(poznaj naszych instruktorów)</a>.</p>
                            </div>
                            <div>
                                <div class="timelist">
                                    ...
                                    <ul>
                                        <li class="flex">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="desc">Spotkanie z instruktorami przed siedzibą Szkoły Narciarskiej FUNRACE, podział na grupy, sprawdzenie sprzętu</div>
                                            </div>
                                        </li>
                                        <li class="flex">
                                               <div class="ico no-shrink"></div>
                                        ...
                                        <li class="flex">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="desc">Szkolenie narciarskie w grupach cz. I</div>
                                            </div>
                                        </li>
                                        <li class="flex">
                                               <div class="ico no-shrink"></div>
                                        ...
                                        <li class="flex">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="desc">Szkolenie narciarskie w grupach cz. II<br>Odbiór dzieci.</div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div>
                                <div class="average-list">
                                    <h3>Dlaczego wybrać <span>MAMUCIK KURS FERYJNY?</span></h3>
                                    <ul>
                                        <li><span>16 godz. zajęć na śnieguu</span></li>
                                        <li><span>2,5 godz. opieki i zajęć poza narciarskich</span></li>
                                        <li><span>25% zniżki na wypożyczenie sprzętu narciarskiego w Wypożyczalni FUNRACE – Centrum Testowym HEAD</span></li>
                                        <li><span>jako jedyna Szkoła Narciarska na Jaworzynie nauczamy dzieci wg. pierwszego w Polsce Programu Nauczania Dzieci SITN PZN</span></li>
                                        <li><span>jJAKO PIERWSZA szkoła na Jaworzynie Krynickiej umożliwiamy odbiór dzieci przy dolnej stacji wyciągu gondolowego (rodzice nie muszą wjeżdżać na szczyt Jaworzyny)!</span></li>
                            ...
                            <div>
                                 <div class="average-list">
                                   <div class="cost">
                                       <div class="price">Cena: 699 zł</div>
    ...
    <div class="container padding">
        ...
        <div class="wrapper flex flex-justify-center flex-justify-between-ml flex-wrap">
              ...
              <a href="<?php echo home_url('zima/oferta/mamucik/mamucik-snowboardowy'); ?>" class="element">
                <div class="inner">
                    <div class="picture" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/mamucik-snowboardowy.jpg)"></div>
                    <div class="name">
