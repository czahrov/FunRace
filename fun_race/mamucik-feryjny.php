        ...
        <div class="container padding">
            <div class="intro flex flex-column">
                ...
                <div class="col col1 flex flex-column flex-row-ml">
                    <div class="image flex flex-items-start flex-justify-center"><img src="<?php echo get_template_directory_uri(); ?>/img/mamucik-feryjny.jpg" alt="mamucik-kurs-świąteczny"></div>
                    <div class="boxes">
                        <div class="box">
